    ...
    >
        ...
        <template v-if="formType==='add' && levelCount2>0">
            <ul class="tbody addType" v-for="i in levelCount2" :key="i">
                <li>{{i}}</li>
                <li>
                    <input type="text" class="initScore" value />
                </li>
                <li>
                    <input type="text" class="upgradeScore" value />
                </li>
                <li>
                    <input type="text" class="eliminateScore" value />
                </li>
            </ul>
        </template>
        <template v-if="formType==='add' && levelCount2===0">
        ...
        >
            <ul class="tbody addType" v-for="(item,index) in thatFormObj" :key="item.id">
                ...
                <li>
                    <input
                        type="text"
                        class="eliminateScore"
                        v-model="item.eliminateScore"
                        :disabled="inputReadOnly"
                    />
                </li>
            </ul>
