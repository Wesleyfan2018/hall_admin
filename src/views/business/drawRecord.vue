    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData" @cell-dblclick="ToUserinfo">
                <el-table-column align="center" label="记录ID" prop="recordID">
                </el-table-column>
                <el-table-column align="center" label="玩家ID" prop="playerID" class-name="a-hover">
                </el-table-column>
                <el-table-column align="center" label="昵称" prop="nickname">
                </el-table-column>
                <el-table-column align="center" label="账户ID" prop="accountID">
                </el-table-column>
                <el-table-column align="center" label="手机号码" prop="phone">
                </el-table-column>
                <el-table-column align="center" label="提现金额" prop="drawAmount">
                </el-table-column>
                ...
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        <el-button v-if="tableData[scope.$index].status==3 " type="primary" size="medium" @click="viewReason(scope.row)">查看原因</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            filterStatusType: -1,
            totalPage: 0,
            statusTypes: [{ 'type': -1, 'name': '全部' }, { 'type': 1, 'name': '审核中' }, { 'type': 2, 'name': '已到账' }, { 'type': 3, 'name': '已拒绝' }],
            pageSize: 25,
            currentPage: 1,
