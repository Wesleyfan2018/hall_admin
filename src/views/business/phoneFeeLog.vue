    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData" @cell-dblclick="ToUserinfo">
                ...
                <el-table-column align="center" label="充值时间" prop="time">
                </el-table-column>
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        <el-button v-if="tableData[scope.$index].status==11 " type="primary" size="medium" @click="viewReason(scope.row)">查看原因</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            filterStatusType: -1,
            totalPage: 0,
            statusTypes: [{ 'type': -1, 'name': '全部' }, { 'type': 0, 'name': '成功' }, { 'type': 11, 'name': '失败' }, { 'type': 1, 'name': '处理中' }],
            pageSize: 25,
            currentPage: 1,
