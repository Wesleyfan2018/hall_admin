    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData" @cell-dblclick="ToUserinfo">
                ...
                <el-table-column align="center" label="openid" prop="openId"></el-table-column>
                <el-table-column align="center" label="提现单号" prop="orderId"></el-table-column>
                <el-table-column align="center" label="提现金额" prop="money"></el-table-column>
                <el-table-column align="center" label="场景" prop="scenesName"></el-table-column>
                <el-table-column align="center" label="场景下唯一标识" prop="uniqId"></el-table-column>
                <el-table-column align="center" label="提现状态" prop="statusName"></el-table-column>
                <el-table-column align="center" label="提现时间" prop="time"></el-table-column>
