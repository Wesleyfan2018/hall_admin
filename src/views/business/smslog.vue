    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData">
                ...
                <el-table-column align="left" label="短信内容" prop="content" width="400">
                </el-table-column>
                <el-table-column align="center" label="发送返回" prop="ext">
                </el-table-column>
                <el-table-column align="center" label="状态" prop="statusName" width="170">
                </el-table-column>
                <el-table-column align="center" label="短信商" prop="ispName" width="190">
                </el-table-column>

                <el-table-column align="center" label="接收号码" prop="phone">
                </el-table-column>
                <el-table-column align="center" label="发送时间" prop="create_time" width="200">
                </el-table-column>
            </el-table>
            ...
            revoke('/hall-admin-new/index.php?m=CallProxy&p=callCommon', data).then(res => {
                if (res.code === 0) {
                    ...
                    for (let i in this.tableData) {
                        ...
                        this.tableData[i].create_time = t.getFullYear() + '-' + (t.getMonth() + 1) + '-' + t.getDate() + ' ' + t.getHours() + ':' + t.getMinutes() + ':' + t.getSeconds();
