    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData" @cell-dblclick="ToUserinfo">
                <el-table-column align="center" label="玩家ID" prop="showUid" class-name="a-hover"></el-table-column>
                <el-table-column align="center" label="玩家昵称" prop="nickName"></el-table-column>
                <el-table-column align="center" label="平台订单号" prop="order_id"></el-table-column>
                <el-table-column align="center" label="第三方订单号" prop="order_num"></el-table-column>
                <el-table-column align="center" label="充值金额" prop="price"></el-table-column>
                <el-table-column align="center" label="充值方式" prop="pay_platform"></el-table-column>
                <el-table-column align="center" label="充值时间" prop="order_create_time"></el-table-column>
                <el-table-column align="center" label="充值状态" prop="statusName"></el-table-column>
                <el-table-column align="center" label="操作">
                    <template slot-scope="scope">
                        <el-button type="primary" size="small" @click="viewReason(scope.row)">支付状态</el-button>
                        <br />
                        <el-button
                            v-if="tableData[scope.$index].status==1 ||tableData[scope.$index].status==10"
                            type="primary"
                            size="small"
