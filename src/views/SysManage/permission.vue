    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData">
                ...
                <el-table-column align="center" label="权限标识" prop="perm"></el-table-column>
                <el-table-column align="center" label="菜单" prop="menu"></el-table-column>
                <el-table-column align="center" label="api(|分割)" prop="apis"></el-table-column>

                <el-table-column align="center" label="所属组" prop="GroupName"></el-table-column>
            ...
            revoke('/index.php?m=permission&p=lists', data).then(res => {
                if (res.code === 0) {
                    ...
                    for (let i in this.tableData) {
                        this.tableData[i]['GroupName'] = this.rPerm[
                            this.tableData[i]['pid']
                        ]
                            ? this.rPerm[this.tableData[i]['pid']]['name']
                            : ''
                    }
                }
            })
