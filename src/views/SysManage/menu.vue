    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData">
                ...
                <el-table-column align="center" label="路径标识" prop="path_name">
                </el-table-column>
                <el-table-column align="center" label="icon" prop="icon">
                </el-table-column>
                <el-table-column align="center" label="序号" prop="sort">
                </el-table-column>
                <el-table-column align="center" label="所属游戏" prop="game_names">
                </el-table-column>
            ...
            <el-dialog title="编辑菜单信息" :visible.sync="editVisble" width="30%" :before-close="handleEditClose">
                <el-form label-position="right" label-width="120px" :model="selectData">
                  ...
                  <el-form-item label="所属游戏">
                        ...
                        <el-checkbox v-for="v in this.projects"  :label="v.id" :key="v.id">{{v.name}}</el-checkbox>
                        </el-checkbox-group>
                   </el-form-item>
                </el-form>
