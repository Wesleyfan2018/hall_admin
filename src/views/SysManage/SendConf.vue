<template>
    <div class="app-containei">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-table-column align="center" label="当前审批人" prop="approverName">
                </el-table-column>
                ...
                <el-table-column align="center" label="申请人" prop="adminName">
                </el-table-column>
                 <el-table-column align="center" label="操作">
                  <template slot-scope="scope">
                    <el-button  size="mini" type="primary" @click="diff(scope.row)">对比</el-button>
                    <el-button  v-if="logs[scope.$index].status==1 && logs[scope.$index].approver==adminId" size="mini" type="primary" @click="apply(scope.row,1)">通过</el-button>
                    <el-button  v-if="logs[scope.$index].status==1 && logs[scope.$index].approver==adminId" size="mini" type="primary" @click="apply(scope.row,2)">拒绝</el-button>
                    <el-button  v-if="logs[scope.$index].status==3 && logs[scope.$index].aid==adminId" size="mini" type="primary" @click="send(scope.row)">发布</el-button>
                    <el-button  v-if="logs[scope.$index].aid==adminId && (logs[scope.$index].status!=6 && logs[scope.$index].status!=4 && logs[scope.$index].status!=5)" size="mini" type="primary" @click="cancel(scope.row)">取消</el-button>
                   </template>
                </el-table-column>
