        ...
        <div class="filter-container">
            ...
            <div class="table-main">
                <el-table border :data="tableData">
                    ...
                    <el-table-column align="center" label="分享id" prop="config_id" width="70"></el-table-column>
                    <el-table-column align="center" label="分享文案" prop="share_text"></el-table-column>
                    <el-table-column align="center" label="场景" prop="scene_name" width="170"></el-table-column>
                    <el-table-column align="center" label="玩法" prop="game_name" width="120"></el-table-column>
...
export default {
    ...
    data() {
        return {
            ...
            objectName:
                '/hall/production/common/share/' +
                datesFormat(new Date(), 'yyyyMMddhhmm'),
            objectUrl: '',
            image_url: '',
    ...
    methods: {
        ...
        changeShareConfirm() {
            ...
            // 获取审批流程
            revoke('/index.php?m=CommConf&p=updateConfByApi', data).then(
                res => {
                    if (res.code === 0) {
                        this.$message({
                            message: res.msg,
        ...
        confirEdit() {
            ...
            args.share_image_url = this.objectUrl
                ? this.objectUrl
                : this.selectConf.image_url;
            ...
            revoke('/index.php?m=CallProxy&p=callCommon', data).then(res => {
                if (res.code === 0) {
                    ...
                    for (let i in this.tableData) {
                        this.tableData[i].scene_name = this.sceneList[
                            this.tableData[i].share_scene
                        ]
                            ? this.sceneList[this.tableData[i].share_scene][
                                'scene_name'
                            ]
                            : '';
                        this.tableData[i].game_name = this.gameList[
                            this.tableData[i].play_type
                        ]
                            ? this.gameList[this.tableData[i].play_type][
                                'game_name'
                            ]
                            : '';
                    }
        ...
        confirAdd() {
            ...
            this.addConf.share_image_url = this.image_url
                ? this.image_url
                : this.objectUrl;
            let data = {
                callm: 'share',
