    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <el-table border :data="tableData">
                 ...
                 <el-table-column align="center" label="渠道ID" prop="channel_code">
                </el-table-column>
                <el-table-column align="center" label="客户端类型" prop="sysname">
                </el-table-column>
                <el-table-column align="center" label="状态" prop="statusname">
                </el-table-column>
                <el-table-column align="center" label="渠道名称" prop="channel_name">
                </el-table-column>
                <el-table-column align="center" label="操作">
                <template slot-scope="scope">
                    <el-button type="primary" v-if="scope.row.status==1" @click="handleStatus(scope.$index, scope.row,2)">停用</el-button>
                    <el-button type="primary" v-if="scope.row.status==2" @click="handleStatus(scope.$index, scope.row,1)">启用</el-button>
        ...
        <div class="dialog_div">
            <el-dialog title="修改名称" :visible.sync="editVisble" width="30%" :before-close="handleEditClose" :closeOnClickModal='clickclose'>
            ...
            <el-dialog title="新增信息" :visible.sync="addVisble" width="30%" :before-close="handleAddClose">
                 <el-form label-position="right" label-width="120px" :model="selectData">
...
export default {
    ...
    methods: {
        confirEdit() {
            revoke('/index.php?m=channelconf&p=edit', this.selectData).then(res => {
                if (res.code === 0) {
            ...
            revoke('/index.php?m=channelconf&p=getList', args).then(res => {
                if (res.code === 0) {
                    ...
                    for (let i in this.tableData) {
                        this.tableData[i].sysname = this.systype[this.tableData[i].sys_id];
                        this.tableData[i].statusname = this.statustype[this.tableData[i].status];
                    }
