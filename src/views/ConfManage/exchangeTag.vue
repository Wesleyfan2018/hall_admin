...
export default {
    ...
    data() {
        return {
            ...
            Approvers: [],
            ButConf: { copyBut: 1, syncBut: 1, approver: 1 },
    ...
    methods: {
        ...
        applySend(args) {
            ...
            let data = {
                key: this.confKey,
                subkey: '',
                table: this.confTable,
                approver: approverId,
                approval_id: this.approvalId,
                comm_conf_id: this.id
            }
