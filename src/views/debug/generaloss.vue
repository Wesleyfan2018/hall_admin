    ...
    <div class="app-containei">
      <div class="filter-container">
            ...
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-table-column align="left" label="资源地址" prop="url" width="400">
                </el-table-column>
                <el-table-column align="center" label="备注" prop="args">
                </el-table-column>
                ...
                <el-table-column align="center" label="操作人" prop="adminName">
                 ...
                 <el-table-column align="center" label="操作">
                  <template slot-scope="scope">
                    <el-button  size="mini" type="primary" @click="catback(scope.row)">复制</el-button>
                    <el-button  size="mini" type="primary" @click="catback(scope.row)">删除</el-button>
                   </template>
                </el-table-column>
            </el-table>
