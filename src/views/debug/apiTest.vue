<template>
    <div class="app-containei">
            <el-form :inline="false" class="demo-form-inline">
                <el-form-item label="Hall-Main接口测试">
                </el-form-item>


                <el-form-item label="请求方法：">
                    <el-select v-model="module_name" placeholder="请选择模块" class="nav-select" @change="selectModule">
                        <el-option
                            v-for="(i) in modules"
                            :key="(i)"
                            :label="i"
              ...
              <el-form-item label="参数(json):">
                   <el-input type="textarea"  class="form-input" v-model="args" :rows="2" placeholder="请求参数"  resize="vertical"></el-input>
              </el-form-item>


              <el-form-item label="返回:">
                   <el-input type="textarea"   class="form-input" v-model="out" :rows="2" placeholder="返回内容"  resize="vertical"></el-input>
              </el-form-item>
               <el-form-item>
                  <el-button type="success" style="margin: 8px 0px 0px 0px" size="small" @click="run">请求</el-button>
                </el-form-item>
