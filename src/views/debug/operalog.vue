    ...
    <div class="app-containei">
       ...
       <el-form :inline="true" class="demo-form-inline">
                <el-form-item label="时间：">
                  <el-date-picker v-model="selectDate" type="daterange" align="right" unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" ></el-date-picker>
                </el-form-item>
            ...
            <el-form :inline="true" class="demo-form-inline">
                ...
                <el-table-column align="left" label="url" prop="url" width="400">
                </el-table-column>
                <el-table-column align="center" label="参数" prop="args">
                </el-table-column>

                <el-table-column align="center" label="时间" prop="cTimeFmt" width="190">
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        loadLog(data) {
            console.log('test');
            data['stime'] = this.selectDate[0] ? parseInt(this.selectDate[0] / 1000, 10) : '';
            data['etime'] = this.selectDate[1] ? parseInt(this.selectDate[1] / 1000, 10) : '';
