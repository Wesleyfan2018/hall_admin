            ...
            <el-form :inline="false" class="demo-form-inline">
                ...
                <el-form-item>
                    <div class="tag-group text-center" style="width:90%;margin:0 auto;">
                        <el-tag
                            v-for="(item, idx) in echartTag"
                            :key="(item, idx)"
                            :effect="item.name == currentTag ? 'dark' : 'plain'"
...
export default {
    ...
    data() {
        return {
            ...
            subTag: [
                { zh: '数量', name: '_num', format: 'percent', title: '数量' },
        ...
        initEchart() {
            ...
            for (let tagIndex in this.tagList) {
                ...
                for (let xAxisIndex in xAxis) {
                    ...
                    seriesItemData.push(
                        this.tableData[dataIndex][this.tagList[tagIndex].name]
                    )
                }
