    ...
    <div class="app-containei">
        <div class="filter-container">
            ...
            <div class="table-main" style="display:">
                <pie-echart v-if="show_1" domid="hallRecharge" :echartOption="echartOption1" :searchTime="timestamp"></pie-echart>
                <pie-echart v-if="show_2" domid="quickRecharge" :echartOption="echartOption2" :searchTime="timestamp" style="margin-top:30px;"></pie-echart>
                <pie-echart v-if="show_3" domid="rechargeScale" :echartOption="echartOption3" :searchTime="timestamp" style="margin-top:30px;"></pie-echart>
            </div>
                ...
                <el-table stripe border :data="tableData" v-loading="loading">
                    ...
                    <el-table-column align="center" label="大厅充值">
                        <template v-for="(item, idx) in tagList">
                            <el-table-column v-if="idx <= 7 && idx > 1" :key="(item, idx)" align="center" :prop="item.name">
                    ...
                    <el-table-column align="center" label="牌局充值">
                        <template v-for="(item, idx) in tagList">
                            <el-table-column v-if="idx <= 13 && idx > 7" :key="(item, idx)" align="center" :prop="item.name">
                                <template slot="header" :slot-scope="scope">
                                    <span>{{item.zh}}元</span>
                                </template>
                            </el-table-column>
