<template>
    <div class="app-containei">
        ...
        <el-table border :data="dataList" :default-sort="{prop: 'allNum', order: 'descending'}">
            <el-table-column align="center" label="分享ID" prop="id"></el-table-column>
            <el-table-column align="center" label="分享次数" prop="shareCount"></el-table-column>
            <el-table-column align="center" label="分享人数" prop="shareNum"></el-table-column>
        </el-table>
    </div>
</template>
<script>
